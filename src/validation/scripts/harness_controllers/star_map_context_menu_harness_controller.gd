...
## Validation harness for star map context menu lifecycle.
## Tests: right-click shows menu, hover panel hides, left-click dismisses.
...
func _physics_process(_delta: float) -> void:
	...
	match _step:
		40:
			# Right-click planet earth to show context menu
			star_map._show_context_menu("earth")
		80:
			# Left-click empty space to dismiss context menu
